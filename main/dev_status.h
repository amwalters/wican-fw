...
// One-shot bypass for AutoPID low-voltage gates after waking from sleep.
#define DEV_AUTOPID_WAKE_BYPASS_LOW_VOLTAGE_BIT BIT21
...
#define dev_status_set_autopid_wake_bypass_low_voltage()   dev_status_set_bits(DEV_AUTOPID_WAKE_BYPASS_LOW_VOLTAGE_BIT)
#define dev_status_clear_autopid_wake_bypass_low_voltage() dev_status_clear_bits(DEV_AUTOPID_WAKE_BYPASS_LOW_VOLTAGE_BIT)
...
#define dev_status_is_autopid_wake_bypass_low_voltage() dev_status_is_bit_set(DEV_AUTOPID_WAKE_BYPASS_LOW_VOLTAGE_BIT)
